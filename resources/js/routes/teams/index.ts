...
* @see app/Http/Controllers/Teams/TeamController.php:23
...
* @see app/Http/Controllers/Teams/TeamController.php:35
* @route '/settings/teams'
*/
...
* @see app/Http/Controllers/Teams/TeamController.php:47
...
* @see app/Http/Controllers/Teams/TeamController.php:84
* @route '/settings/teams/{team}'
*/
...
* @see app/Http/Controllers/Teams/TeamController.php:116
* @route '/settings/teams/{team}'
*/
...
* @see app/Http/Controllers/Teams/TeamController.php:104
